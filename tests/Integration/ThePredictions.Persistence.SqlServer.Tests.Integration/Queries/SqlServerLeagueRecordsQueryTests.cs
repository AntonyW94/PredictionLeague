...
/// <summary>Runs <see cref="LeagueRecordsQueryConformanceTests"/> against SQL Server.</summary>
[Collection(DatabaseCollection.Name)]
[Trait(IntegrationTrait.Name, IntegrationTrait.Value)]
public class SqlServerLeagueRecordsQueryTests(SqlServerDatabaseFixture fixture)
    : LeagueRecordsQueryConformanceTests, IAsyncLifetime
{
    private readonly SqlServerTestHarness _harness = new(fixture);

    protected override ILeagueRecordsQuery Query => new LeagueRecordsQuery(_harness.ReadDbConnection);
