...
/// <summary>Runs <see cref="RoundHeaderQueryConformanceTests"/> against SQL Server.</summary>
[Collection(DatabaseCollection.Name)]
[Trait(IntegrationTrait.Name, IntegrationTrait.Value)]
public class SqlServerRoundHeaderQueryTests(SqlServerDatabaseFixture fixture)
    : RoundHeaderQueryConformanceTests, IAsyncLifetime
{
    private readonly SqlServerTestHarness _harness = new(fixture);

    protected override IRoundHeaderQuery Query => new RoundHeaderQuery(_harness.ReadDbConnection);
