...
/// <summary>Runs <see cref="SeasonLookupQueryConformanceTests"/> against SQL Server.</summary>
[Collection(DatabaseCollection.Name)]
[Trait(IntegrationTrait.Name, IntegrationTrait.Value)]
public class SqlServerSeasonLookupQueryTests(SqlServerDatabaseFixture fixture)
    : SeasonLookupQueryConformanceTests, IAsyncLifetime
{
    private readonly SqlServerTestHarness _harness = new(fixture);

    protected override ISeasonLookupQuery Query => new SeasonLookupQuery(_harness.ReadDbConnection);
