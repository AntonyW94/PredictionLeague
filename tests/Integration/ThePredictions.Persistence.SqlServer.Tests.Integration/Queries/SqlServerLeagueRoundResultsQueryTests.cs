...
/// <summary>Runs <see cref="LeagueRoundResultsQueryConformanceTests"/> against SQL Server.</summary>
[Collection(DatabaseCollection.Name)]
[Trait(IntegrationTrait.Name, IntegrationTrait.Value)]
public class SqlServerLeagueRoundResultsQueryTests(SqlServerDatabaseFixture fixture)
    : LeagueRoundResultsQueryConformanceTests, IAsyncLifetime
{
    private readonly SqlServerTestHarness _harness = new(fixture);

    protected override ILeagueRoundResultsQuery Query => new LeagueRoundResultsQuery(_harness.ReadDbConnection);
