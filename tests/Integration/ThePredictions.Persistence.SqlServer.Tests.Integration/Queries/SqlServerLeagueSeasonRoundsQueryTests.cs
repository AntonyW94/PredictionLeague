...
/// <summary>Runs <see cref="LeagueSeasonRoundsQueryConformanceTests"/> against SQL Server.</summary>
[Collection(DatabaseCollection.Name)]
[Trait(IntegrationTrait.Name, IntegrationTrait.Value)]
public class SqlServerLeagueSeasonRoundsQueryTests(SqlServerDatabaseFixture fixture)
    : LeagueSeasonRoundsQueryConformanceTests, IAsyncLifetime
{
    private readonly SqlServerTestHarness _harness = new(fixture);

    protected override ILeagueSeasonRoundsQuery Query => new LeagueSeasonRoundsQuery(_harness.ReadDbConnection);
