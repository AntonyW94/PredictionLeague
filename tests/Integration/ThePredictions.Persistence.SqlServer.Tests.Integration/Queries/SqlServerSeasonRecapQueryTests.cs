...
/// <summary>Runs <see cref="SeasonRecapQueryConformanceTests"/> against SQL Server.</summary>
[Collection(DatabaseCollection.Name)]
[Trait(IntegrationTrait.Name, IntegrationTrait.Value)]
public class SqlServerSeasonRecapQueryTests(SqlServerDatabaseFixture fixture)
    : SeasonRecapQueryConformanceTests, IAsyncLifetime
{
    private readonly SqlServerTestHarness _harness = new(fixture);

    protected override ISeasonRecapQuery Query => new SeasonRecapQuery(_harness.ReadDbConnection);
