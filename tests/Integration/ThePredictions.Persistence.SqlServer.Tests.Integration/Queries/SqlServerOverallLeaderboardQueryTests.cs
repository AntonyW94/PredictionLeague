...
/// <summary>Runs <see cref="OverallLeaderboardQueryConformanceTests"/> against SQL Server.</summary>
[Collection(DatabaseCollection.Name)]
[Trait(IntegrationTrait.Name, IntegrationTrait.Value)]
public class SqlServerOverallLeaderboardQueryTests(SqlServerDatabaseFixture fixture)
    : OverallLeaderboardQueryConformanceTests, IAsyncLifetime
{
    private readonly SqlServerTestHarness _harness = new(fixture);

    protected override IOverallLeaderboardQuery Query => new OverallLeaderboardQuery(_harness.ReadDbConnection);
