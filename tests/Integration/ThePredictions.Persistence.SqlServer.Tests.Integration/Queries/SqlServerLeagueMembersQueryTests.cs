...
/// <summary>Runs <see cref="LeagueMembersQueryConformanceTests"/> against SQL Server.</summary>
[Collection(DatabaseCollection.Name)]
[Trait(IntegrationTrait.Name, IntegrationTrait.Value)]
public class SqlServerLeagueMembersQueryTests(SqlServerDatabaseFixture fixture)
    : LeagueMembersQueryConformanceTests, IAsyncLifetime
{
    private readonly SqlServerTestHarness _harness = new(fixture);

    protected override ILeagueMembersQuery Query => new LeagueMembersQuery(_harness.ReadDbConnection);
