...
/// <summary>Runs <see cref="LeagueDetailQueryConformanceTests"/> against SQL Server.</summary>
[Collection(DatabaseCollection.Name)]
[Trait(IntegrationTrait.Name, IntegrationTrait.Value)]
public class SqlServerLeagueDetailQueryTests(SqlServerDatabaseFixture fixture)
    : LeagueDetailQueryConformanceTests, IAsyncLifetime
{
    private readonly SqlServerTestHarness _harness = new(fixture);

    protected override ILeagueDetailQuery Query => new LeagueDetailQuery(_harness.ReadDbConnection);
