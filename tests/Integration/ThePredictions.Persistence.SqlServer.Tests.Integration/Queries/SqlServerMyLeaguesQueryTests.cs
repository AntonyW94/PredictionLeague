...
/// <summary>Runs <see cref="MyLeaguesQueryConformanceTests"/> against SQL Server.</summary>
[Collection(DatabaseCollection.Name)]
[Trait(IntegrationTrait.Name, IntegrationTrait.Value)]
public class SqlServerMyLeaguesQueryTests(SqlServerDatabaseFixture fixture)
    : MyLeaguesQueryConformanceTests, IAsyncLifetime
{
    private readonly SqlServerTestHarness _harness = new(fixture);

    protected override IMyLeaguesQuery Query => new MyLeaguesQuery(_harness.ReadDbConnection);
