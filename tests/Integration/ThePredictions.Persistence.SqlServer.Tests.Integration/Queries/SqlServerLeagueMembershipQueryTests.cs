...
/// <summary>Runs <see cref="LeagueMembershipQueryConformanceTests"/> against SQL Server.</summary>
[Collection(DatabaseCollection.Name)]
[Trait(IntegrationTrait.Name, IntegrationTrait.Value)]
public class SqlServerLeagueMembershipQueryTests(SqlServerDatabaseFixture fixture)
    : LeagueMembershipQueryConformanceTests, IAsyncLifetime
{
    private readonly SqlServerTestHarness _harness = new(fixture);

    protected override ILeagueMembershipQuery Query => new LeagueMembershipQuery(_harness.ReadDbConnection);
