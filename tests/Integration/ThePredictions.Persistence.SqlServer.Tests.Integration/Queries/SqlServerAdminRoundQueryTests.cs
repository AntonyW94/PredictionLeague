...
/// <summary>Runs <see cref="AdminRoundQueryConformanceTests"/> against SQL Server.</summary>
[Collection(DatabaseCollection.Name)]
[Trait(IntegrationTrait.Name, IntegrationTrait.Value)]
public class SqlServerAdminRoundQueryTests(SqlServerDatabaseFixture fixture)
    : AdminRoundQueryConformanceTests, IAsyncLifetime
{
    private readonly SqlServerTestHarness _harness = new(fixture);

    protected override IAdminRoundQuery Query => new AdminRoundQuery(_harness.ReadDbConnection);
