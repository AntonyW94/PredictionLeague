...
/// <summary>
/// The SVG inner markup for each badge glyph, drawn inside the 0 0 120 120 badge face. Shared by the
/// client badge icon (which colours it via CSS <c>currentColor</c>) and the server-side badge PNG
/// renderer (which substitutes <c>currentColor</c> for a baked colour, since email has no CSS).
/// </summary>
