...
| [0010](./0010-entry-fee-settlement.md) | Entry-fee settlement | Accepted | product, security, legal | Admin bank details (encrypted) shown at join; code shared freely, admin accepts on payment; software never touches the money. |
