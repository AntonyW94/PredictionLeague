...
- **"Same competition" is keyed on `Season.CompetitionId`** (the `Competitions` reference table, 0018), not the API league id — so a provider switch never invalidates an earned reward.
...
- 0008, 0009, 0012, 0018; `season-passes/13-sms-earned-upgrade.md`
