...
- **NEW section "Season Passes, payments and refunds":**
  > Season Passes are one-off, non-recurring charges processed by **Stripe**. Under the Consumer Contracts Regulations you normally have a 14-day right to cancel; by purchasing and immediately using a Season Pass you **consent to immediate access and acknowledge you lose that 14-day cancellation right**. The SMS reminder option is non-refundable, and choosing to stop receiving reminders does not entitle you to a refund.
