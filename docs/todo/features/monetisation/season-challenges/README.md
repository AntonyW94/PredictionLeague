...
- It relates closely to the existing [`user-experience/achievements-badges`](../../user-experience/achievements-badges/) feature; decide whether to merge or keep season-scoped challenges distinct.
